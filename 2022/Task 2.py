...
if __name__ == "__main__" :
    ...
    label1 = Label(root, text = "What is your principal value?: ")
    label2 = Label(root, text = "What is your time period?: ")
    label3 = Label(root, text = "What is your rate of interest?: ")
    label4 = Label(root, text = "Your simple interest is:" )
    ...
    button1 = Button(root, text = "Submit", command = calculate_ci)
